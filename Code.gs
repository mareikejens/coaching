 ...
 * Conditional questions (q4a, q4b, q12a) exist as non-required items here —
...
var QUESTIONS = [
  ...
  { key: 'q1a', title: '01a · Which AI tools are you currently using, even occasionally?', type: 'checkbox', required: true,
  ...
  { key: 'q9', title: "09 · What have you tried that didn't work? What got in the way?", type: 'paragraph', required: true },
  ...
  // Conditional follow-ups are numbered <parent>a (12a, not 13) so the visible
  // numbering never skips when they're hidden. House convention for all surveys.
  { key: 'q12a', title: '12a · [If fuzzy / black box] Should the technical fundamentals be part of our coaching?', type: 'mc',
    choices: ['Yes - dedicated time on this', 'A little context along the way is enough', 'Skip the theory - I just want to use the tools'] },

  { key: 'q13', title: '13 · If you got only ONE thing out of this coaching series, what would it be?', type: 'text', required: true },

  { key: 'q14', title: '14 · HOMEWORK: The one use case we build together in session 1 (+ the real example you will bring)', type: 'paragraph', required: true },
];
    ...
    postData: {
      contents: JSON.stringify({
        ...
        answers: {
          ...
          q7: 'Test use case.',
          q8: 'Test prompt.',
          q9: 'Test failed attempt.',
          q10: 'Test data handling.',
          q11: 'Test tasks.',
          q12: "I know the basics but it's fuzzy",
          q12a: 'A little context along the way is enough',
          q13: 'Test outcome.',
          q14: 'Test homework.',
        },
      }),
